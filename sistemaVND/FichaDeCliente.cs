...
{
    public partial class FichaDeCliente : Form
    {
        ...
        public FichaDeCliente(string cliente)
        {
            InitializeComponent();
        ...
        //SOLO NUMEROS, ESPACIOS Y GIONES EN CUIT
        ...
        //SOLO NUMEROS, ESPACIOS, PARENTESIS Y GUIONES EN TELEFON0
        ...
        //SOLO NUMEROS ESPACIOS Y GUIONES EN INGRESOS BRUTOS
        ...
        private void FichaDeCliente_Load(object sender, EventArgs e)
        {
