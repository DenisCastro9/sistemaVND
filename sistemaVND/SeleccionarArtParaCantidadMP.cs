...
{
    public partial class SeleccionarArtParaCantidadMP : Form
    {
        ...
        public SeleccionarArtParaCantidadMP()
        {
            InitializeComponent();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                CantidadMPxArticulo f = new CantidadMPxArticulo(nombre);
                f.Show(this);
                cargarData();
            }
            else
        ...
        private void SeleccionarArtParaCantidadMP_Load(object sender, EventArgs e)
        {
            dataGridView1.ClearSelection();
            numeroRegistros();
        }
